...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 19, 2024 at 04:29 PM
...
(1, 'motor', '', 20000000, NULL),
(2, 'pensil', '', 2000, NULL),
(3, 'pulpen', '', 3500, NULL),
(9, 'knalpot', '', 1500000, NULL),
...
--
ALTER TABLE `logs`
  MODIFY `id_logs` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `stok`
--
ALTER TABLE `stok`
  MODIFY `id_stok` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
